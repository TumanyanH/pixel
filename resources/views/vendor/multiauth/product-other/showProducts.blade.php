...
<a href="{{ route('admin.product-other.create', ['category_id' => $category->id]) }}" class="btn btn-success">+ Ավելացնել ապրանք</a>
...
<div class="card" style="width: 18rem;">
    ...
    <div class="card-body">
        ...
        @endif
        <a href="{{ route('admin.product-other.show', ['product_other' => $product->id]) }}" class="btn btn-primary">Մանրամասներ</a>
    </div>
</div>
